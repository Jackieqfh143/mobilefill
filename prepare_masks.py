...
if __name__ == '__main__':
    ...
    for i in tqdm(range(total_num)):
        ...
        Image.fromarray(mask).save(mask_save_dir + f'/{i:0>5d}_im_mask.jpg')
        Image.fromarray(masked_img).save(masked_save_dir + f'/{i:0>5d}_im_masked.jpg')
        Image.fromarray(img).save(img_save_dir + f'/{i:0>5d}_im_truth.jpg')
